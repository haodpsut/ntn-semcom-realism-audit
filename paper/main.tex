...
The checklist in Table~\ref{tab:census} covers the physical effects an NTN evaluation could
instantiate and the channel models it could use. Two design decisions matter. The effects are
...
$25^\circ$. Dashed lines mark medians. The bimodality of the centre panel reflects the difference
...
\begin{figure}[t]
\centering
\includegraphics[width=0.62\textwidth]{../figures/out/fig3-census.pdf}
...
\numFsplMed~dB across a \numDurMed~s window. Of \numCoded{} works that could be read and coded,
